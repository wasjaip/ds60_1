...
### [Исследование надежности заемщиков](https://github.com/wasjaip/ds60_1/Исследование%20надёжности%20заёмщиков)
...
### [Продажа квартир в Санкт-Петербурге — анализ рынка недвижимости](https://github.com/wasjaip/ds60_1/Продажа%20квартир%20в%20Санкт-Петербурге%20—%20анализ%20рынка%20недвижимости)
...
### [Определение выгодного тарифа для телеком компании](https://github.com/wasjaip/ds60_1/Определение%20выгодного%20тарифа%20для%20телеком%20компании)
**Цель:**\
...
### [Изучение закономерностей, определяющих успешность игр](https://github.com/wasjaip/ds60_1/Изучение%20закономерностей%2C%20определяющих%20успешность%20игр)
...
### [Рекомендация тарифов](https://github.com/wasjaip/ds60_1/Рекомендация%20тарифов)

**Цель:**\
На основании данных подготовленных в проекте ["Определение выгодного тарифа для телеком компании"](https://github.com/wasjaip/ds60_1/Определение%20выгодного%20тарифа%20для%20телеком%20компании)  подобрать и обучить модель, для прогнозирования предпочтений пользователей при выборе тарифов.
\
**Используемые инструменты:**\
Pandas, Matplotlib, sklearn, numpy

### [Отток клиентов банка](https://github.com/wasjaip/ds60_1/Отток%20клиентов%20банка)
...
### [Выбор региона для разработки новых нефтяных месторождений](https://github.com/wasjaip/ds60_1/Выбор%20региона%20для%20разработки%20новых%20нефтяных%20месторождений)
...
### [Разработка алгоритма для защиты данных](https://github.com/wasjaip/ds60_1/Разработка%20алгоритма%20для%20защиты%20данных)
**Цель:**\
...
### [Предсказание цены автомобиля](https://github.com/wasjaip/ds60_1/Предсказание%20цены%20автомобиля)
**Цель:**\
...
### [Прогнозирование заказов такси](https://github.com/wasjaip/ds60_1/Прогнозирование%20заказов%20такси)
**Цель:**\
...
### [Классификация комментариев](https://github.com/wasjaip/ds60_1/Классификация%20комментариев)
**Цель:**\
...
### [Исследование данных авиакомпании](https://github.com/wasjaip/ds60_1/Исследование%20данных%20авиакомпании)
**Цель:**\
...
### [Определение возраста по фото](https://github.com/wasjaip/ds60_1/Определение%20возраста%20по%20фото)
**Цель:**\
Необходимо построить модель, способную определять возраст людей по фотографиям.\
**Используемые инструменты:**\
Pandas, Plotly, keras, Matplotlib, numpy, CV

### [Прогноз оттока клиентов для оператора связи](https://github.com/wasjaip/ds60_1/Определение%20возраста%20по%20фото)
**Цель:**\
Необходимо построить модель, способную определять возраст людей по фотографиям.\
**Используемые инструменты:**\
